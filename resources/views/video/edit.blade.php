            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="recent__product">
                        ...
                        <form method="POST" action="{{route('video.update',$video->id)}}" enctype="multipart/form-data" class="row video">
                            @csrf
                            @method('PUT')
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                @if (Auth::user()->hasRole('admin'))
                                    <label><h6>Autor (E-mail)</h6></label>
                                    <input type="text" placeholder="E-mail" name="email" value="{{$video->user->email}}" required/>
                                @endif
